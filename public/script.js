...
document.querySelector('body').addEventListener('click', (e) => {
  ...
  function onSubmit(e) {
    ...
    fetch('/shorten', {
      ...
      document.querySelector('#shortenUrl').appendChild(shortUrl)
      document.querySelector('#shortenUrl').appendChild(copyButton)
      document.querySelector('#shortenUrl').appendChild(lineBreak)
